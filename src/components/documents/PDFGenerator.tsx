...
// Quanby Case Management Platform – PDF Generator using @react-pdf/renderer
...
function LegalDocumentPDF({
  ...
  return (
    <Document
      title={title}
      author="Quanby Case Management Platform"
      subject={`${caseType} – ${caseNumber}`}
      creator="Quanby Case Management Platform v1.0"
    >
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-400 text-center">
        Generated by Quanby Case Management Platform · RA 10173 compliant · Document hash logged for audit trail
      </p>
    </div>
  )
}
